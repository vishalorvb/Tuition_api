...
urlpatterns = [
    ...
    path('update_teacher_profile/<int:teacherId>', views.update_teacher_Profile, name='update_teacher_profile'),
    path('getTecher_info/<int:teacherId>', views.getTecher_info, name='getTecher_info'),
